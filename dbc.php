...
$cppaneluser = 'maldazil';
$domainname = 'http://maldazilla.in';
$pagetitle = "Kishan Credit Card. Malda District";
$pageheader = "Kishan Credit Card. Malda District";
...
/*************** reCAPTCHA KEYS****************/
$publickey = "6LeiWOESAAAAAPZ1EOXlTtkLOUvIDuC3kw9npEL0";
$privatekey = "6LeiWOESAAAAAPjHpgC0nKt16IPuy7frulzL6vDZ";

/**** PAGE PROTECT CODE  ********************************
This code protects pages to only logged in AdminUsers. If AdminUsers have not logged in then it will redirect to login page.
