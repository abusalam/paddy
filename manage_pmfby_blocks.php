...
<table border="1" cellspacing="0" cellpadding="5" width="100%" class="TFtable">
  <tr>
    <td colspan="5" align="center" valign="middle" nowrap="nowrap"><strong>Block Wise Kishan Credit Card</strong></td>
    </tr>
    ...
    <td align="center" valign="middle"><strong>Paddy Procured</strong></td>
...
while($row_blockname = mysql_fetch_array($result_blockname)){
	 ...
	 ?>
	  <tr>
    <td align="left" valign="middle"><a href="manage_pmfby_forms.php?blid=<? echo $BlockName; ?>"><? echo $BlockName ; ?></a></td>
    <td align="center" valign="middle"><b><? $query_count_block="select COUNT(ID) AS TotalBlockForm, SUM(IF(KCCNo  !='', 1,0)) as TotalBlockKCCNo , SUM(IF(ExistingLoan !='', 1,0)) as TotalBlockExistingLoan, SUM(IF(paddy IS NOT NULL, 1, 0)) as TotalBlockPaddy  from PMFBYKCC where Block='$BlockName'";
...
$TotalBlockPaddy=$row_count_block['TotalBlockPaddy'];; //TODO: Fetch Paddy
  }
  echo $TotalBlockForm;  ?></b></td>
   <td align="center"><? echo $TotalBlockPaddy; ?></td>
 ...
 <tr>
    ...
    <td align="center" valign="middle"><b><? $query_count_total="select COUNT(ID) AS TotalUpForm, SUM(IF(KCCNo  !='', 1,0)) as TotalKCCNo , SUM(IF(ExistingLoan !='', 1,0)) as TotalExistingLoan, SUM(IF(paddy IS NOT NULL, 1, 0)) as TotalPaddy  from PMFBYKCC";
...
$TotalPaddy=$row_count_total['TotalPaddy'];; //TODO: Fetch Paddy
  }
  echo $TotalUpForm;  ?></b></td>
  <td align="center"><? echo $TotalPaddy; ?></td>
