...
while($row_blockname = mysql_fetch_array($result_blockname)){
    ...
    <td align="center" valign="middle"><b><? $query_count_block="select COUNT(ID) AS TotalBlockForm, SUM(IF(KCCNo  !='', 1,0)) as TotalBlockKCCNo , SUM(IF(ExistingLoan !='', 1,0)) as TotalBlockExistingLoan  from PMFBYKCC where Block='$BlockName'";
...
$num_result_count_block= mysql_numrows($result_count_block);
 ...
 <tr>
    ...
    <td align="center" valign="middle"><b><? $query_count_total="select COUNT(ID) AS TotalUpForm, SUM(IF(KCCNo  !='', 1,0)) as TotalKCCNo , SUM(IF(ExistingLoan !='', 1,0)) as TotalExistingLoan  from PMFBYKCC";
